...
//L.geoJSON(sanFranAirport, {
  ...
  //  pointToLayer: function(feature, latlng) {
    //  console.log(feature);
      //return L.marker(latlng).bindPopup("<h2>" + feature.properties.city + ", " + feature.properties.name + ", " + feature.properties.country + "</h2>");
//    }
...
//      onEachFeature: function(feature, layer) {
   //   console.log(layer);
  //  layer.bindPopup("<h2>" + feature.properties.city + feature.properties.name +feature.properties.faa);
  //  }
   // }).addTo(map);
...
let airportData = "https://raw.githubusercontent.com//Julcatan/Mapping_Earthquakes/Mapping_GeoJSON_Points/Mapping_GeoJSON_Points/static/js/majorAirports.json";
